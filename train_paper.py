...
train_dataloader, test_dataloader = torch.utils.data.DataLoader(torch.utils.data.Subset(train_dataset, [0]), shuffle=True, generator=rng_cpu, batch_size=4), torch.utils.data.DataLoader(test_dataset, batch_size=4)
